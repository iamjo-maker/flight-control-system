This is the code you should run before you run the FC code. This code was written for ESP-32 DevKit with Arduino IDE.
If you are using a different board, check the GPIO pin numbers and change them accordingly.
